...
const text_to_speech = new TextToSpeechV1({
    authenticator: new IamAuthenticator({ apikey: 'J7lF3XVN1SYq4B0iwFTARkhRu_Lhm9ig7EVSSQ-Xs5E7'}),
    serviceUrl: 'https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/338f9aed-f8a3-4793-b7b4-3a447aa84e1a'
});
...
async function play(request, response){
    ...
    text_to_speech
        ...
        .then(repairedFile => {
            ...
            fs.writeFileSync(`${id}.wav`,repairedFile);
        })
        .catch(err =>{
            console.log(err);
        });
